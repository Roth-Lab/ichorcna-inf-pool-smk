...
def main(args):
    ...
    cell_profiles, cell_to_clone, clone_ploidy, data = load_data(args.hapclone_data_file, args.hapclone_results_file)

    clone_prevalence = generate_clone_prevalence(
        clone_ploidy,
        args.clone_prevalence_file,
        args.clone_prevalence_prior,
        rng,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--coverage", default=1, type=float)

    parser.add_argument("-p", "--clone-prevalence-prior", default=1, type=float)

    parser.add_argument("-t", "--tumour-content", default=0.1, type=float)

    parser.add_argument("--clone-prevalence-file", default=None)
